...
for (sk in 1:length(dd_variant)){
  ...
  plot(data_sites[,'mean_hyp'],data_sites[,'npp'],xlab = 'mean HYP', ylab = 'NPP',cex=0.8, main = 'Mean HYP by species',ylim = c(0,3000),xlim = c(1,3))
  abline(fit_npp)
  ...
  pdf(file_name,width = wd1, height = ht1)
  plot(data_sites[,'mean_hyp_den'],data_sites[,'npp'],xlab = 'mean HYP den', ylab = 'NPP',cex=0.8, main = 'Mean HYP by individuals',ylim = c(0,3000),xlim = c(1,3))
  abline(fit_npp_den)
  ...
  pdf(file_name,width = wd1, height = ht1)
  plot(data_sites[,'mean_hyp_mass_den'],data_sites[,'npp'],xlab = 'mean HYP mass den', ylab = 'NPP',cex=0.8, main = 'Mean HYP by biomass',ylim = c(0,3000),xlim = c(1,3))
  abline(fit_npp_mass_den)
  ...
  pdf(file_name,width = wd1, height = ht1)
  plot(data_sites[,'mean_hyp_ing_den'],data_sites[,'npp'],xlab = 'mean HYP ing den', ylab = 'NPP',cex=0.8, main = 'Mean HYP by energy intake',ylim = c(0,3000),xlim = c(1,3))
  tx <- paste('R2 =',round(summary(fit_npp_ing_den)$r.squared,digits = 2))
  abline(fit_npp_ing_den)
  text(2.7,2600,tx)
  dev.off()
  ...
  pdf(file_name,width = wd1, height = ht1)
  plot(data_sites[,'mean_hyp'],data_sites[,'prec'],xlab = 'mean HYP', ylab = 'PREC',cex=0.8, main = 'Mean HYP by species',ylim = c(0,3500),xlim = c(1,3))
  ...
  pdf(file_name,width = wd1, height = ht1)
  plot(data_sites[,'mean_log_mass'],data_sites[,'prec'],xlab = 'mean log MASS', ylab = 'PREC',cex=0.8, main = 'Mean log MASS by species',ylim = c(0,3500),xlim = c(0,800))
  tx <- paste('R2 =',round(summary(fit_prec)$r.squared,digits = 2))
  tx <- paste('R2 =',round(summary(fit_prec_log_mass)$r.squared,digits = 2))
  abline(fit_prec_log_mass)
  text(2.7,3000,tx)
  dev.off()
  ...
  pdf(file_name,width = wd1, height = ht1)
  plot(data_sites[,'mean_hyp_den'],data_sites[,'prec'],xlab = 'mean HYP', ylab = 'PREC',cex=0.8, main = 'Mean HYP by individuals',ylim = c(0,3500),xlim = c(1,3))
  ...
  pdf(file_name,width = wd1, height = ht1)
  plot(data_sites[,'mean_hyp_mass_den'],data_sites[,'prec'],xlab = 'mean HYP', ylab = 'PREC',cex=0.8, main = 'Mean HYP by biomass',ylim = c(0,3500),xlim = c(1,3))
  tx <- paste('R2 =',round(summary(fit_prec_mass_den)$r.squared,digits = 2))
  text(2.7,3000,tx)
  abline(fit_prec_mass_den)
  dev.off()
  ...
  pdf(file_name,width = wd1, height = ht1)
  plot(data_sites[,'mean_hyp_ing_den'],data_sites[,'prec'],xlab = 'mean HYP', ylab = 'PREC',cex=0.8, main = 'Mean HYP by energy intake',ylim = c(0,3500),xlim = c(1,3))
  tx <- paste('R2 =',round(summary(fit_prec_ing_den)$r.squared,digits = 2))
  text(2.7,3000,tx)
  abline(fit_prec_ing_den)
  dev.off()
  ...
  pdf(file_name,width = wd1, height = ht1)
  plot(data_sites[,'mean_hyp'],data_sites[,'temp'],xlab = 'mean HYP', ylab = 'TEMP',cex=0.8, main = 'Mean HYP by species',ylim = c(-15,35),xlim = c(1,3))
  ...
  pdf(file_name,width = wd1, height = ht1)
  plot(data_sites[,'mean_log_mass'],data_sites[,'temp'],xlab = 'mean log MASS', ylab = 'TEMP',cex=0.8, main = 'Mean log MASS by species',ylim = c(-15,35),xlim = c(0,800))
  tx <- paste('R2 =',round(summary(fit_temp_log_mass)$r.squared,digits = 2))
  abline(fit_temp_log_mass)
  text(600,-12,tx)
  dev.off()
  ...
  pdf(file_name,width = wd1, height = ht1)
  plot(data_sites[,'mean_hyp_den'],data_sites[,'temp'],xlab = 'mean HYP den', ylab = 'TEMP',cex=0.8, main = 'Mean HYP by individuals',ylim = c(-15,35),xlim = c(1,3))
  ...
  pdf(file_name,width = wd1, height = ht1)
  plot(data_sites[,'mean_hyp_mass_den'],data_sites[,'temp'],xlab = 'mean HYP mass den', ylab = 'TEMP',cex=0.8, main = 'Mean HYP by biomass',ylim = c(-15,35),xlim = c(1,3))
  tx <- paste('R2 =',round(summary(fit_temp_mass_den)$r.squared,digits = 2))
  abline(fit_temp_mass_den)
  text(1.5,-12,tx)
  dev.off()
  ...
  pdf(file_name,width = wd1, height = ht1)
  plot(data_sites[,'mean_hyp_ing_den'],data_sites[,'temp'],xlab = 'mean HYP ing den', ylab = 'TEMP',cex=0.8, main = 'Mean HYP by energy intake',ylim = c(-15,35),xlim = c(1,3))
  tx <- paste('R2 =',round(summary(fit_temp_ing_den)$r.squared,digits = 2))
  abline(fit_temp_ing_den)
  text(1.5,-12,tx)
  dev.off()
